...
export default function LandingPage() {
  const handleDownload = (e: React.MouseEvent) => {
    ...
    link.download = "hostinger-listo.zip";
  ...
  return (
    <div className="min-h-screen bg-slate-50 font-sans text-slate-900">
      {/* Header */}
      <div className="bg-blue-600 text-white text-center py-3 px-4 font-bold flex flex-col sm:flex-row items-center justify-center gap-4 z-50 relative">
        <span>¡Tu código para Hostinger está listo!</span>
        <button
          onClick={handleDownload}
          className="bg-white text-blue-600 px-4 py-2 rounded-full text-sm font-bold shadow-md hover:bg-blue-50 transition-colors flex items-center gap-2"
        >
          <FileText size={16} />
          Descargar ZIP para Hostinger
        </button>
      </div>
