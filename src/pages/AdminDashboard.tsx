    ...
    <div className="flex h-screen bg-slate-50 font-sans overflow-hidden">
      ...
      <aside className="w-64 bg-blue-900 text-white flex flex-col transition-all shadow-xl z-20">
        ...
        <nav className="flex-1 p-4 space-y-2 overflow-y-auto">
          <button className="w-full flex items-center gap-3 px-4 py-3 rounded-xl font-medium transition-all bg-blue-700 text-white shadow-md">
            <Users size={20} />
            Clientes
          </button>
        </nav>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {clients.length === 0 ? (
                  ...
                  clients.map((client) => (
                    <div
                      key={client.id}
                      className="bg-white rounded-2xl shadow-sm border border-slate-200 p-6 hover:shadow-md transition-all hover:-translate-y-1 group"
                    >
